...
import com.acostajp.config.CloudinaryConfig;
import com.acostajp.model.Image;
...
public class DemoControllerProduct {
	...
	@PostMapping("/image")
	public ResponseEntity<Image> addProducto(@RequestParam MultipartFile file) throws IOException {
